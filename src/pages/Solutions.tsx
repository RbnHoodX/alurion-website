...
const Solutions = () => {
  const [activeSolution, setActiveSolution] =
    useState<string>("retained-search");
      ...
      <div className="pt-16">
        ...
        <div className="bg-gray-50 py-16 md:py-24">
          <div className="container mx-auto max-w-6xl px-4">
            <h1 className="text-4xl md:text-6xl font-bold text-alurion-primary mb-6">
              Our Solutions
            </h1>
            <p className="text-lg md:text-xl text-gray-700 max-w-3xl">
              Comprehensive talent solutions designed to transform your
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="lg:w-1/4 hidden lg:block">
              <div className="sticky top-24 bg-gray-50 rounded-2xl p-6 border border-gray-100">
                <h3 className="font-medium text-sm text-gray-500 uppercase mb-4">
                  All Solutions
                </h3>
                    ...
                    >
                      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                        <div className="p-8 md:p-12">
                          <h2 className="text-3xl font-bold text-alurion-primary mb-6">
                            {solution.title}
                          </h2>
                      ...
                      <div className="mt-16">
                        <h3 className="text-xl font-semibold mb-6 text-alurion-primary">
                          Other Solutions
                        </h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                          {solutions
                            ...
                            .map((relatedSolution) => (
                              ...
                              >
                                <h4 className="font-medium mb-2 text-alurion-primary">
                                  {relatedSolution.title}
                                </h4>
                                <p className="text-sm text-gray-600 line-clamp-2">
                                  {relatedSolution.description.substring(
                                    0,
                                    100
                                  )}
                                  ...
