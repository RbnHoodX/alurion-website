      ...
      <div className="pt-16">
        <section className="py-20 md:py-28">
          <div className="container mx-auto max-w-7xl px-4 md:px-8">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-bold mb-6 text-alurion-primary">What Our Clients Say</h1>
            ...
            <div className="mb-20">
              <h2 className="text-2xl font-semibold mb-8 text-alurion-primary">Featured Testimonials</h2>
              <Carousel 
                opts={{
                  align: "start",
                  loop: true,
            ...
            <div className="mt-20 text-center">
              <h3 className="text-2xl font-semibold mb-4 text-alurion-primary">Ready to work with us?</h3>
              <p className="mb-8 text-gray-600 max-w-2xl mx-auto">
                Join the growing list of satisfied clients who've found their perfect talent match with Alurion.
              </p>
              <a 
                href="/contact"
