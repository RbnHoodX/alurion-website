      ...
      <div className="container mx-auto flex justify-between items-center px-4 bg-alurion-primary">
        <div className="flex items-center">
          <Link to="/" className="flex items-center">
            <svg width="120" height="48" viewBox="0 0 995.32 504.62" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-2">
              <g id="Layer_1-2" data-name="Layer 1">
                <g>
                  ...
                  <g className="fill-white opacity-80 hidden lg:block">
