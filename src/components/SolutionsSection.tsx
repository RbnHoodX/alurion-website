...
const SolutionsSection = () => {
  ...
  return (
    <section
      id="solutions"
      className="section py-24 px-4 relative bg-white overflow-hidden"
    >
      <div className="container mx-auto max-w-6xl">
        <h2 className=" text-center section-title">Our Solutions</h2>
        <p className="text-lg text-gray-700 mb-16 align-center text-center md:mx-[100px]">
          At Alurion Talent Group, we don't just fill roles—we architect
          transformation. As strategic partners and fractional leaders, we help
          organizations attract, develop, and retain top talent that fuels
          ...
          {solutions.map((solution) => (
            ...
            >
              <div className="p-8 h-full flex flex-col bg-gray-50">
                <h3 className="text-xl font-semibold text-alurion-primary mb-4">
                  {solution.title}
                </h3>
