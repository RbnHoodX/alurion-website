...
export const allTestimonials = [
  ...
  },
  {
    ...
    company: "Xceleration",
    featured: false,
    image: "/James_Sheridan.png",
  },
  {
    quote:
      "Monica is a great resource that takes the time to understand your needs and match your needs with a prospect's needs and talent! She is thorough, reliable, responsible, understanding and values matching the right talent with the right Company.",
    author: "Wendy Boyd",
    position: "Chief Distribution Officer",
    company: "World Financial Group",
    featured: false,
    image: "/Wendy_Boyd.png",
  },
  {
    quote:
      "Monica has an incredible eye for talent and has served as a sage advisor and partner. She has been absolutely clutch in identifying and delivering candidates to fill key roles. The war for talent is real and Monica is a great ally to have!",
    author: "Oral Muir",
      ...
      <div className="container mx-auto text-center">
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <TestimonialCard
            ...
            image={allTestimonials[currentTestimonial].image}
          />
