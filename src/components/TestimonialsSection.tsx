...
export const allTestimonials: Testimonial[] = [
  ...
  {
    quote: "Melanie understands recruitment from every angle. She has experience across multiple industries, roles, and levels, from entry to executive. She is an expert in building processes and teams from the ground up to deliver best-in-class services. She is proactive, strategic, a strong communicator, and a true thought partner and trusted advisor.",
    author: "Catherine Moy",
    position: "Chief People Officer",
    company: "YMCA of the USA",
    image: testimonialImages.melanie
  }
];
