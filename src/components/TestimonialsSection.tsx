...
const testimonialImages = {
  ...
  james: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=256&q=80',
  ...
  oral: 'https://images.unsplash.com/photo-1567515004624-219c11d31f2e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=256&q=80',
  alvaro: 'https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=256&q=80',
  erin: 'https://images.unsplash.com/photo-1499952127939-9bbf5af6c51c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=256&q=80',
  soheil: 'https://images.unsplash.com/photo-1521119989659-a83eee488004?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=256&q=80',
  jana: 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=256&q=80',
  ira: 'https://images.unsplash.com/photo-1502378735452-bc7d86632805?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=256&q=80',
  jeff: 'https://images.unsplash.com/photo-1504257432389-52343af06ae3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=256&q=80',
};
...
const TestimonialsSection = () => {
  ...
  const testimonials: (Testimonial & { image?: string })[] = [
    {
    ...
    <section id="testimonials" className="relative py-24 overflow-hidden">
      ...
      <div className="container mx-auto relative z-10 px-4 md:px-8">
        ...
        <div className="flex justify-center mb-12">
          <div className="inline-flex rounded-full shadow-sm p-1 bg-white border border-alurion-accent/30" role="group">
            <button
              onClick={() => {
                setActiveFilter('all');
                setPage(0);
              ...
              className={`px-6 py-2 text-sm font-medium rounded-full transition-all duration-200 ${
                activeFilter === 'all'
                  ? 'bg-alurion-accent text-white shadow-sm'
                  : 'bg-transparent text-gray-600 hover:text-alurion-primary'
              }`}
            >
              All Testimonials
            </button>
