        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 text-white leading-tight fade-in">
              Alurion <span className="text-alurion-accent">Talent</span> Group
            </h1>
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center fade-in delay-400">
              <a href="#solutions" className="bg-alurion-accent text-alurion-primary px-8 py-4 rounded-md font-medium hover:bg-opacity-90 transition-all">
                Our Solutions
              </a>
              <a href="#contact" className="bg-transparent border border-alurion-accent text-alurion-accent px-8 py-4 rounded-md font-medium hover:bg-alurion-accent/10 transition-all">
                Contact Us
              </a>
            </div>
          </div>
