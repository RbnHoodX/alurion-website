          ...
          {blogPosts.map((post, index) => (
            <div key={index} className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold mb-2 text-alurion-secondary">{post.title}</h3>
                <p className="text-gray-600 mb-4">{post.excerpt}</p>
                <a href="#" className="text-alurion-secondary font-medium hover:underline">Read More</a>
              </div>
            </div>
          ))}
        </div>
